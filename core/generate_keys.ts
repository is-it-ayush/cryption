 ...
 */
export async function generate_aes_key(size: number = 256, extractable: boolean = true, algorithm: SymmetricAlgorithms = "AES-CBC", keyUsages: crypto.webcrypto.KeyUsage[] = ["encrypt", "decrypt"]) {
